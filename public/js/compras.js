    ...
    function preencherTabela(tabela) {
        ...
        for (var i = 0; i < tabela.length; i++) {
            ...
            html += `
            <div class="card" style="cursor:pointer;" onclick="window.location.href='/mykeeper/compras_itens?id_lista_compra=${tabela[i].id}'">
                ...
                <div class="card-body">
                    ...
                    <div class="card-botoes-status">
                        <button class="btn-concluir" onclick="event.stopPropagation(); window.location.href='/mykeeper/compras_concluir?id=${tabela[i].id}'">
                            ✓ Concluída
                        </button>
                    ...
                    <div class="card-botoes">
                        ...
                        <button class="btn-editar" onclick="event.stopPropagation()">
                            <a href="/mykeeper/compras_alterar?id=${tabela[i].id}">Editar</a>
                        </button>
    ...
    document.getElementById('criarCompras').addEventListener('click', () => {
        window.location.href = '/mykeeper/compras_novo';
    });
